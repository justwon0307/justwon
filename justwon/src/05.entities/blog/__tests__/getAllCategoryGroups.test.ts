import { getAllCategoryGroups, sampleCategoryGroups } from "@entities/blog";

describe("getAllCategoryGroups", () => {
  it("should fetch correctly", async () => {
    ...
    const categories = await getAllCategoryGroups();
  ...
  it("should handle fetch error", async () => {
    ...
    await expect(getAllCategoryGroups()).rejects.toThrow(
